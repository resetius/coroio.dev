...
\mbox{\hyperlink{struct_n_net_1_1_t_value_task}{TFuture}}$<$ void $>$ \mbox{\hyperlink{struct_n_net_1_1_t_byte_reader_a06eec1258239223532bf1ef4d8e24eab}{Read}} (void \texorpdfstring{$\ast$}{*}data, size\+\_\+t size)
...
\mbox{\hyperlink{struct_n_net_1_1_t_value_task}{TFuture}}$<$ std\+::string $>$ \mbox{\hyperlink{struct_n_net_1_1_t_byte_reader_a0fba0689cf0fc26d154189697742d286}{Read\+Until}} (const std\+::string \&delimiter)
...
{\em \doxylink{class_n_net_1_1_t_socket}{TSocket}} & The socket type used for reading bytes. It must provide a method {\ttfamily TFuture$<$ssize\+\_\+t$>$ Read\+Some(void\texorpdfstring{$\ast$}{*} buffer, size\+\_\+t size)} which returns\+:
\begin{DoxyItemize}
...
template$<$typename \mbox{\hyperlink{class_n_net_1_1_t_socket}{TSocket}}$>$ \\
\mbox{\hyperlink{struct_n_net_1_1_t_value_task}{TFuture}}$<$ void $>$ \mbox{\hyperlink{struct_n_net_1_1_t_byte_reader}{NNet\+::\+TByte\+Reader}}$<$ \mbox{\hyperlink{class_n_net_1_1_t_socket}{TSocket}} $>$\+::\+Read (\begin{DoxyParamCaption}\item[{void \texorpdfstring{$\ast$}{*}}]{data}{, }\item[{size\+\_\+t}]{size}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
template$<$typename \mbox{\hyperlink{class_n_net_1_1_t_socket}{TSocket}}$>$ \\
\mbox{\hyperlink{struct_n_net_1_1_t_value_task}{TFuture}}$<$ std\+::string $>$ \mbox{\hyperlink{struct_n_net_1_1_t_byte_reader}{NNet\+::\+TByte\+Reader}}$<$ \mbox{\hyperlink{class_n_net_1_1_t_socket}{TSocket}} $>$\+::\+Read\+Until (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{delimiter}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
