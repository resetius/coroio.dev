...
\mbox{\hyperlink{struct_n_net_1_1_t_value_task}{TValue\+Task}}$<$ void $>$ \mbox{\hyperlink{struct_n_net_1_1_t_byte_writer_a2a77c89db4f196b917ee79f2d42300e5}{Write}} (const void \texorpdfstring{$\ast$}{*}data, size\+\_\+t size)
...
\mbox{\hyperlink{struct_n_net_1_1_t_value_task}{TValue\+Task}}$<$ void $>$ \mbox{\hyperlink{struct_n_net_1_1_t_byte_writer_aad8d69302e5e15dd8e515aa67eda093b}{Write}} (const \mbox{\hyperlink{struct_n_net_1_1_t_line}{TLine}} \&line)
...
{\em \doxylink{class_n_net_1_1_t_socket}{TSocket}} & The socket type used for writing bytes. It must provide a method {\ttfamily \doxylink{struct_n_net_1_1_t_value_task}{TValue\+Task$<$ssize\+\_\+t$>$} Write\+Some(const void\texorpdfstring{$\ast$}{*} data, size\+\_\+t size)} which returns\+:
\begin{DoxyItemize}
...
\hline
\end{DoxyTemplParams}
\hypertarget{struct_n_net_1_1_t_byte_writer_autotoc_md3}{}\doxysubsubsubsection{\texorpdfstring{Example Usage}{Example Usage}}\label{struct_n_net_1_1_t_byte_writer_autotoc_md3}
...
\Hypertarget{struct_n_net_1_1_t_byte_writer_aad8d69302e5e15dd8e515aa67eda093b}\index{NNet::TByteWriter$<$ TSocket $>$@{NNet::TByteWriter$<$ TSocket $>$}!Write@{Write}}
...
{\footnotesize\ttfamily \label{struct_n_net_1_1_t_byte_writer_aad8d69302e5e15dd8e515aa67eda093b} 
template$<$typename \mbox{\hyperlink{class_n_net_1_1_t_socket}{TSocket}}$>$ \\
\mbox{\hyperlink{struct_n_net_1_1_t_value_task}{TValue\+Task}}$<$ void $>$ \mbox{\hyperlink{struct_n_net_1_1_t_byte_writer}{NNet\+::\+TByte\+Writer}}$<$ \mbox{\hyperlink{class_n_net_1_1_t_socket}{TSocket}} $>$\+::\+Write (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{struct_n_net_1_1_t_line}{TLine}} \&}]{line}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



Writes a {\ttfamily \doxylink{struct_n_net_1_1_t_line}{TLine}} object by sequentially writing its parts. 

This method calls \doxylink{struct_n_net_1_1_t_byte_writer_a2a77c89db4f196b917ee79f2d42300e5}{Write(const void\texorpdfstring{$\ast$}{*}, size\+\_\+t)} for {\ttfamily line.\+Part1} and then {\ttfamily line.\+Part2}.
...
A \doxylink{struct_n_net_1_1_t_value_task_3_01void_01_4}{TValue\+Task$<$void$>$} that completes once both parts have been fully written.
\end{DoxyReturn}
...
\hline
\end{DoxyExceptions}
\Hypertarget{struct_n_net_1_1_t_byte_writer_a2a77c89db4f196b917ee79f2d42300e5}\index{NNet::TByteWriter$<$ TSocket $>$@{NNet::TByteWriter$<$ TSocket $>$}!Write@{Write}}
\index{Write@{Write}!NNet::TByteWriter$<$ TSocket $>$@{NNet::TByteWriter$<$ TSocket $>$}}
\doxysubsubsection{\texorpdfstring{Write()}{Write()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \label{struct_n_net_1_1_t_byte_writer_a2a77c89db4f196b917ee79f2d42300e5} 
template$<$typename \mbox{\hyperlink{class_n_net_1_1_t_socket}{TSocket}}$>$ \\
\mbox{\hyperlink{struct_n_net_1_1_t_value_task}{TValue\+Task}}$<$ void $>$ \mbox{\hyperlink{struct_n_net_1_1_t_byte_writer}{NNet\+::\+TByte\+Writer}}$<$ \mbox{\hyperlink{class_n_net_1_1_t_socket}{TSocket}} $>$\+::\+Write (\begin{DoxyParamCaption}\item[{const void \texorpdfstring{$\ast$}{*}}]{data}{, }\item[{size\+\_\+t}]{size}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
A \doxylink{struct_n_net_1_1_t_value_task_3_01void_01_4}{TValue\+Task$<$void$>$} that completes when all bytes have been written or an exception is thrown if the socket is closed.
\end{DoxyReturn}
