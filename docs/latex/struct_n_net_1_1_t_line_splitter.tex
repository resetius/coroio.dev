...
\end{DoxyItemize}\hypertarget{struct_n_net_1_1_t_line_splitter_autotoc_md7}{}\doxysubsubsubsection{\texorpdfstring{Example Usage}{Example Usage}}\label{struct_n_net_1_1_t_line_splitter_autotoc_md7}
