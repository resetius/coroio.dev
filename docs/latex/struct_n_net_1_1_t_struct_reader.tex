...
\mbox{\hyperlink{struct_n_net_1_1_t_value_task}{TValue\+Task}}$<$ T $>$ \mbox{\hyperlink{struct_n_net_1_1_t_struct_reader_a2a8f1a16e1a64481863d2d66a9437a1d}{Read}} ()
...
This class expects the socket to provide a method {\ttfamily \doxylink{struct_n_net_1_1_t_value_task}{TValue\+Task$<$ssize\+\_\+t$>$} Read\+Some(void\texorpdfstring{$\ast$}{*} buffer, size\+\_\+t size)}, which returns\+:
\begin{DoxyItemize}
...
\hline
\end{DoxyTemplParams}
\hypertarget{struct_n_net_1_1_t_struct_reader_autotoc_md4}{}\doxysubsubsubsection{\texorpdfstring{Example Usage}{Example Usage}}\label{struct_n_net_1_1_t_struct_reader_autotoc_md4}
...
\Hypertarget{struct_n_net_1_1_t_struct_reader_a2a8f1a16e1a64481863d2d66a9437a1d}\index{NNet::TStructReader$<$ T, TSocket $>$@{NNet::TStructReader$<$ T, TSocket $>$}!Read@{Read}}
\index{Read@{Read}!NNet::TStructReader$<$ T, TSocket $>$@{NNet::TStructReader$<$ T, TSocket $>$}}
\doxysubsubsection{\texorpdfstring{Read()}{Read()}}
{\footnotesize\ttfamily \label{struct_n_net_1_1_t_struct_reader_a2a8f1a16e1a64481863d2d66a9437a1d} 
template$<$typename T, typename \mbox{\hyperlink{class_n_net_1_1_t_socket}{TSocket}}$>$ \\
\mbox{\hyperlink{struct_n_net_1_1_t_value_task}{TValue\+Task}}$<$ T $>$ \mbox{\hyperlink{struct_n_net_1_1_t_struct_reader}{NNet\+::\+TStruct\+Reader}}$<$ T, \mbox{\hyperlink{class_n_net_1_1_t_socket}{TSocket}} $>$\+::\+Read (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
A \doxylink{struct_n_net_1_1_t_value_task}{TValue\+Task$<$\+T$>$} that completes once the entire structure is read.
\end{DoxyReturn}
